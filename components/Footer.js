                ...
                <div id="footerContentContainer">
                    ...
                    >
                        ...
                        <div id="footerSocialsContainer" className="flex max-h-12">
                            <Link href={"/https://www.facebook.com/JosephCroft0829/"} id="socialLink" className="social-link">
                            ...
                            <Link href={"/https://www.instagram.com/insta.josephcroft/"} id="socialLink" className="social-link">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2.5rem" height="2.5rem" viewBox="0 0 48 48">
                            ...
                            <Link href={"/https://x.com/JoeCrof14616865"} id="socialLink" className="social-link">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2.5rem" height="2.5rem" viewBox="0 0 48 48">
                            ...
                            <Link href={"/https://www.linkedin.com/in/joseph-croft-b66940135/"} id="socialLink" className="social-link">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2.5rem" height="2.5rem" viewBox="0 0 48 48">
